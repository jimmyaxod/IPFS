...
public final class DHTProtos {
  ...
  public  static final class Record extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return net.axod.DHTProtos.internal_static_Record_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return net.axod.DHTProtos.internal_static_Record_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              net.axod.DHTProtos.Record.class, net.axod.DHTProtos.Record.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof net.axod.DHTProtos.Record)) {
        return super.equals(obj);
      }
      net.axod.DHTProtos.Record other = (net.axod.DHTProtos.Record) obj;
    ...
    public static net.axod.DHTProtos.Record parseFrom(
    ...
    public static net.axod.DHTProtos.Record parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static net.axod.DHTProtos.Record parseFrom(
    ...
    public static net.axod.DHTProtos.Record parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static net.axod.DHTProtos.Record parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static net.axod.DHTProtos.Record parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(net.axod.DHTProtos.Record prototype) {
    ...
    public static final class Builder extends
        ...
        net.axod.DHTProtos.RecordOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return net.axod.DHTProtos.internal_static_Record_descriptor;
      }
      ...
      // Construct using net.axod.DHTProtos.Record.newBuilder()
      private Builder() {
      ...
      public net.axod.DHTProtos.Record getDefaultInstanceForType() {
        return net.axod.DHTProtos.Record.getDefaultInstance();
      }

      public net.axod.DHTProtos.Record build() {
        net.axod.DHTProtos.Record result = buildPartial();
      ...
      public net.axod.DHTProtos.Record buildPartial() {
        net.axod.DHTProtos.Record result = new net.axod.DHTProtos.Record(this);
        result.key_ = key_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof net.axod.DHTProtos.Record) {
          return mergeFrom((net.axod.DHTProtos.Record)other);
        } else {
      ...
      public Builder mergeFrom(net.axod.DHTProtos.Record other) {
        if (other == net.axod.DHTProtos.Record.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        net.axod.DHTProtos.Record parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (net.axod.DHTProtos.Record) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final net.axod.DHTProtos.Record DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new net.axod.DHTProtos.Record();
    }

    public static net.axod.DHTProtos.Record getDefaultInstance() {
  ...
  public interface MessageOrBuilder extends
     ...
     * <code>optional .Message.MessageType type = 1;</code>
     */
    net.axod.DHTProtos.Message.MessageType getType();
     ...
     * <code>optional .Record record = 3;</code>
     */
    net.axod.DHTProtos.Record getRecord();
    /**
     * <pre>
     * Used to return a value
     * PUT_VALUE, GET_VALUE
     ...
     * <code>optional .Record record = 3;</code>
     */
    net.axod.DHTProtos.RecordOrBuilder getRecordOrBuilder();
     ...
     */
    java.util.List<net.axod.DHTProtos.Message.Peer> 
        getCloserPeersList();
    /**
     * <pre>
     * Used to return peers closer to a key in a query
     ...
     * <code>repeated .Message.Peer closerPeers = 8;</code>
     */
    net.axod.DHTProtos.Message.Peer getCloserPeers(int index);
    /**
     * <pre>
     * Used to return peers closer to a key in a query
     * GET_VALUE, GET_PROVIDERS, FIND_NODE
     ...
     * <code>repeated .Message.Peer closerPeers = 8;</code>
     */
    java.util.List<? extends net.axod.DHTProtos.Message.PeerOrBuilder> 
     ...
     * <code>repeated .Message.Peer closerPeers = 8;</code>
     */
    net.axod.DHTProtos.Message.PeerOrBuilder getCloserPeersOrBuilder(
        int index);
     ...
     * <code>repeated .Message.Peer providerPeers = 9;</code>
     */
    net.axod.DHTProtos.Message.Peer getProviderPeers(int index);
    /**
     * <pre>
     * Used to return Providers
     * GET_VALUE, ADD_PROVIDER, GET_PROVIDERS
     ...
     * <code>repeated .Message.Peer providerPeers = 9;</code>
     */
    net.axod.DHTProtos.Message.PeerOrBuilder getProviderPeersOrBuilder(
        int index);
  }
  /**
  ...
  public  static final class Message extends
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              net.axod.DHTProtos.Record.Builder subBuilder = null;
              if (record_ != null) {
                subBuilder = record_.toBuilder();
              }
              record_ = input.readMessage(net.axod.DHTProtos.Record.parser(), extensionRegistry);
              if (subBuilder != null) {
            ...
            case 66: {
              if (!((mutable_bitField0_ & 0x00000010) == 0x00000010)) {
                closerPeers_ = new java.util.ArrayList<net.axod.DHTProtos.Message.Peer>();
                mutable_bitField0_ |= 0x00000010;
              }
              closerPeers_.add(
                  input.readMessage(net.axod.DHTProtos.Message.Peer.parser(), extensionRegistry));
              break;
            }
            case 74: {
              if (!((mutable_bitField0_ & 0x00000020) == 0x00000020)) {
                providerPeers_ = new java.util.ArrayList<net.axod.DHTProtos.Message.Peer>();
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return net.axod.DHTProtos.internal_static_Message_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return net.axod.DHTProtos.internal_static_Message_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              net.axod.DHTProtos.Message.class, net.axod.DHTProtos.Message.Builder.class);
    }
    ...
    public enum MessageType
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return net.axod.DHTProtos.Message.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public enum ConnectionType
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return net.axod.DHTProtos.Message.getDescriptor().getEnumTypes().get(1);
      }
    ...
    public interface PeerOrBuilder extends
       ...
       * <code>optional .Message.ConnectionType connection = 3;</code>
       */
      net.axod.DHTProtos.Message.ConnectionType getConnection();
    }
    /**
    ...
    public  static final class Peer extends
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return net.axod.DHTProtos.internal_static_Message_Peer_descriptor;
      }

      protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
          internalGetFieldAccessorTable() {
        return net.axod.DHTProtos.internal_static_Message_Peer_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                net.axod.DHTProtos.Message.Peer.class, net.axod.DHTProtos.Message.Peer.Builder.class);
      }
       ...
       * <code>optional .Message.ConnectionType connection = 3;</code>
       */
      public net.axod.DHTProtos.Message.ConnectionType getConnection() {
        net.axod.DHTProtos.Message.ConnectionType result = net.axod.DHTProtos.Message.ConnectionType.valueOf(connection_);
        return result == null ? net.axod.DHTProtos.Message.ConnectionType.UNRECOGNIZED : result;
      }
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        if (connection_ != net.axod.DHTProtos.Message.ConnectionType.NOT_CONNECTED.getNumber()) {
      ...
      public boolean equals(final java.lang.Object obj) {
        ...
        if (!(obj instanceof net.axod.DHTProtos.Message.Peer)) {
          return super.equals(obj);
        }
        net.axod.DHTProtos.Message.Peer other = (net.axod.DHTProtos.Message.Peer) obj;
      ...
      public static net.axod.DHTProtos.Message.Peer parseFrom(
          com.google.protobuf.ByteString data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      ...
      public static net.axod.DHTProtos.Message.Peer parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      public static net.axod.DHTProtos.Message.Peer parseFrom(
      ...
      public static net.axod.DHTProtos.Message.Peer parseFrom(java.io.InputStream input)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
            .parseWithIOException(PARSER, input);
      }
      ...
      public static net.axod.DHTProtos.Message.Peer parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
            .parseDelimitedWithIOException(PARSER, input);
      }
      public static net.axod.DHTProtos.Message.Peer parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
      ...
      public static Builder newBuilder(net.axod.DHTProtos.Message.Peer prototype) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
      }
      public Builder toBuilder() {
        return this == DEFAULT_INSTANCE
      ...
      public static final class Builder extends
          ...
          net.axod.DHTProtos.Message.PeerOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
            getDescriptor() {
          return net.axod.DHTProtos.internal_static_Message_Peer_descriptor;
        }
        ...
        // Construct using net.axod.DHTProtos.Message.Peer.newBuilder()
        private Builder() {
          maybeForceBuilderInitialization();
        }
        ...
        public net.axod.DHTProtos.Message.Peer getDefaultInstanceForType() {
          return net.axod.DHTProtos.Message.Peer.getDefaultInstance();
        }

        public net.axod.DHTProtos.Message.Peer build() {
          net.axod.DHTProtos.Message.Peer result = buildPartial();
          if (!result.isInitialized()) {
            throw newUninitializedMessageException(result);
          }
          return result;
        ...
        public net.axod.DHTProtos.Message.Peer buildPartial() {
          net.axod.DHTProtos.Message.Peer result = new net.axod.DHTProtos.Message.Peer(this);
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
          if (other instanceof net.axod.DHTProtos.Message.Peer) {
            return mergeFrom((net.axod.DHTProtos.Message.Peer)other);
          } else {
            super.mergeFrom(other);
            return this;
          }
        ...
        public Builder mergeFrom(net.axod.DHTProtos.Message.Peer other) {
          if (other == net.axod.DHTProtos.Message.Peer.getDefaultInstance()) return this;
        ...
        public Builder mergeFrom(
            ...
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
          net.axod.DHTProtos.Message.Peer parsedMessage = null;
          try {
            parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
          } catch (com.google.protobuf.InvalidProtocolBufferException e) {
            parsedMessage = (net.axod.DHTProtos.Message.Peer) e.getUnfinishedMessage();
            throw e.unwrapIOException();
          } finally {
            if (parsedMessage != null) {
              mergeFrom(parsedMessage);
  ...
  ensureAddrsIsMutable();
         ...
         * <code>optional .Message.ConnectionType connection = 3;</code>
         */
        public Builder setConnection(net.axod.DHTProtos.Message.ConnectionType value) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      private static final net.axod.DHTProtos.Message.Peer DEFAULT_INSTANCE;
      static {
        DEFAULT_INSTANCE = new net.axod.DHTProtos.Message.Peer();
      }

      public static net.axod.DHTProtos.Message.Peer getDefaultInstance() {
        return DEFAULT_INSTANCE;
      }
     ...
     * <code>optional .Message.MessageType type = 1;</code>
     */
    public net.axod.DHTProtos.Message.MessageType getType() {
      net.axod.DHTProtos.Message.MessageType result = net.axod.DHTProtos.Message.MessageType.valueOf(type_);
      return result == null ? net.axod.DHTProtos.Message.MessageType.UNRECOGNIZED : result;
    }
    ...
    private net.axod.DHTProtos.Record record_;
    /**
     * <pre>
     * Used to return a value
     * PUT_VALUE, GET_VALUE
     ...
     * <code>optional .Record record = 3;</code>
     */
    public net.axod.DHTProtos.Record getRecord() {
      return record_ == null ? net.axod.DHTProtos.Record.getDefaultInstance() : record_;
    }
    /**
     * <pre>
     * Used to return a value
     ...
     * <code>optional .Record record = 3;</code>
     */
    public net.axod.DHTProtos.RecordOrBuilder getRecordOrBuilder() {
      return getRecord();
    }

    public static final int CLOSERPEERS_FIELD_NUMBER = 8;
    private java.util.List<net.axod.DHTProtos.Message.Peer> closerPeers_;
    /**
     * <pre>
     * Used to return peers closer to a key in a query
     * GET_VALUE, GET_PROVIDERS, FIND_NODE
     ...
     * <code>repeated .Message.Peer closerPeers = 8;</code>
     */
    public java.util.List<net.axod.DHTProtos.Message.Peer> getCloserPeersList() {
      return closerPeers_;
    }
    /**
     * <pre>
     ...
     * <code>repeated .Message.Peer closerPeers = 8;</code>
     */
    public java.util.List<? extends net.axod.DHTProtos.Message.PeerOrBuilder> 
        getCloserPeersOrBuilderList() {
      return closerPeers_;
    }
    /**
     ...
     * <code>repeated .Message.Peer closerPeers = 8;</code>
     */
    public net.axod.DHTProtos.Message.Peer getCloserPeers(int index) {
     ...
     * <code>repeated .Message.Peer closerPeers = 8;</code>
     */
    public net.axod.DHTProtos.Message.PeerOrBuilder getCloserPeersOrBuilder(
        int index) {
      return closerPeers_.get(index);
    }

    public static final int PROVIDERPEERS_FIELD_NUMBER = 9;
    private java.util.List<net.axod.DHTProtos.Message.Peer> providerPeers_;
    /**
     * <pre>
     * Used to return Providers
     * GET_VALUE, ADD_PROVIDER, GET_PROVIDERS
     ...
     * <code>repeated .Message.Peer providerPeers = 9;</code>
     */
    public java.util.List<net.axod.DHTProtos.Message.Peer> getProviderPeersList() {
     ...
     * <code>repeated .Message.Peer providerPeers = 9;</code>
     */
    public net.axod.DHTProtos.Message.Peer getProviderPeers(int index) {
     ...
     * <code>repeated .Message.Peer providerPeers = 9;</code>
     */
    public net.axod.DHTProtos.Message.PeerOrBuilder getProviderPeersOrBuilder(
        int index) {
      return providerPeers_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
      if (type_ != net.axod.DHTProtos.Message.MessageType.PUT_VALUE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof net.axod.DHTProtos.Message)) {
        return super.equals(obj);
      }
      net.axod.DHTProtos.Message other = (net.axod.DHTProtos.Message) obj;
    ...
    public static net.axod.DHTProtos.Message parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static net.axod.DHTProtos.Message parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static net.axod.DHTProtos.Message parseFrom(
    ...
    public static net.axod.DHTProtos.Message parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static net.axod.DHTProtos.Message parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static net.axod.DHTProtos.Message parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(net.axod.DHTProtos.Message prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() {
      return this == DEFAULT_INSTANCE
    ...
    public static final class Builder extends
        ...
        net.axod.DHTProtos.MessageOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return net.axod.DHTProtos.internal_static_Message_descriptor;
      }
      ...
      // Construct using net.axod.DHTProtos.Message.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public net.axod.DHTProtos.Message getDefaultInstanceForType() {
        return net.axod.DHTProtos.Message.getDefaultInstance();
      }

      public net.axod.DHTProtos.Message build() {
        net.axod.DHTProtos.Message result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public net.axod.DHTProtos.Message buildPartial() {
        net.axod.DHTProtos.Message result = new net.axod.DHTProtos.Message(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        result.type_ = type_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof net.axod.DHTProtos.Message) {
          return mergeFrom((net.axod.DHTProtos.Message)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(net.axod.DHTProtos.Message other) {
        if (other == net.axod.DHTProtos.Message.getDefaultInstance()) return this;
        if (other.type_ != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        net.axod.DHTProtos.Message parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (net.axod.DHTProtos.Message) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
       ...
       * <code>optional .Message.MessageType type = 1;</code>
       */
      public Builder setType(net.axod.DHTProtos.Message.MessageType value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    throw new NullPointerException();
      ...
      private net.axod.DHTProtos.Record record_ = null;
      private com.google.protobuf.SingleFieldBuilderV3<
          net.axod.DHTProtos.Record, net.axod.DHTProtos.Record.Builder, net.axod.DHTProtos.RecordOrBuilder> recordBuilder_;
      /**
       * <pre>
       * Used to return a value
       * PUT_VALUE, GET_VALUE
       ...
       * <code>optional .Record record = 3;</code>
       */
      public Builder setRecord(net.axod.DHTProtos.Record value) {
        if (recordBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setRecord(
          net.axod.DHTProtos.Record.Builder builderForValue) {
        if (recordBuilder_ == null) {
       ...
       * <code>optional .Record record = 3;</code>
       */
      public Builder mergeRecord(net.axod.DHTProtos.Record value) {
        if (recordBuilder_ == null) {
          if (record_ != null) {
            record_ =
              net.axod.DHTProtos.Record.newBuilder(record_).mergeFrom(value).buildPartial();
          } else {
            record_ = value;
          }
          onChanged();
       ...
       * <code>optional .Record record = 3;</code>
       */
      public net.axod.DHTProtos.Record.Builder getRecordBuilder() {
      ...
      public net.axod.DHTProtos.RecordOrBuilder getRecordOrBuilder() {
        if (recordBuilder_ != null) {
          ...
          return record_ == null ?
              net.axod.DHTProtos.Record.getDefaultInstance() : record_;
        }
      }
      /**
       * <pre>
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          net.axod.DHTProtos.Record, net.axod.DHTProtos.Record.Builder, net.axod.DHTProtos.RecordOrBuilder> 
      ...
      private void ensureCloserPeersIsMutable() {
        if (!((bitField0_ & 0x00000010) == 0x00000010)) {
          closerPeers_ = new java.util.ArrayList<net.axod.DHTProtos.Message.Peer>(closerPeers_);
          bitField0_ |= 0x00000010;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          net.axod.DHTProtos.Message.Peer, net.axod.DHTProtos.Message.Peer.Builder, net.axod.DHTProtos.Message.PeerOrBuilder> closerPeersBuilder_;
      ...
      public Builder setCloserPeers(
          int index, net.axod.DHTProtos.Message.Peer value) {
        if (closerPeersBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setCloserPeers(
          int index, net.axod.DHTProtos.Message.Peer.Builder builderForValue) {
        if (closerPeersBuilder_ == null) {
          ensureCloserPeersIsMutable();
       ...
       * <code>repeated .Message.Peer closerPeers = 8;</code>
       */
      public Builder addCloserPeers(net.axod.DHTProtos.Message.Peer value) {
        if (closerPeersBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addCloserPeers(
          net.axod.DHTProtos.Message.Peer.Builder builderForValue) {
        if (closerPeersBuilder_ == null) {
          ensureCloserPeersIsMutable();
      ...
      public Builder addAllCloserPeers(
          java.lang.Iterable<? extends net.axod.DHTProtos.Message.Peer> values) {
        if (closerPeersBuilder_ == null) {
          ensureCloserPeersIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, closerPeers_);
       ...
       * <code>repeated .Message.Peer closerPeers = 8;</code>
       */
      public net.axod.DHTProtos.Message.Peer.Builder getCloserPeersBuilder(
          int index) {
       ...
       * <code>repeated .Message.Peer closerPeers = 8;</code>
       */
      public net.axod.DHTProtos.Message.Peer.Builder addCloserPeersBuilder() {
        return getCloserPeersFieldBuilder().addBuilder(
            net.axod.DHTProtos.Message.Peer.getDefaultInstance());
      }
      /**
       * <pre>
       * Used to return peers closer to a key in a query
      ...
      public net.axod.DHTProtos.Message.Peer.Builder addCloserPeersBuilder(
          int index) {
        return getCloserPeersFieldBuilder().addBuilder(
            index, net.axod.DHTProtos.Message.Peer.getDefaultInstance());
      }
      /**
       * <pre>
       * Used to return peers closer to a key in a query
       ...
       * <code>repeated .Message.Peer closerPeers = 8;</code>
       */
      public java.util.List<net.axod.DHTProtos.Message.Peer.Builder> 
           getCloserPeersBuilderList() {
        return getCloserPeersFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          net.axod.DHTProtos.Message.Peer, net.axod.DHTProtos.Message.Peer.Builder, net.axod.DHTProtos.Message.PeerOrBuilder> 
          getCloserPeersFieldBuilder() {
        if (closerPeersBuilder_ == null) {
      ...
      private void ensureProviderPeersIsMutable() {
        if (!((bitField0_ & 0x00000020) == 0x00000020)) {
          providerPeers_ = new java.util.ArrayList<net.axod.DHTProtos.Message.Peer>(providerPeers_);
          bitField0_ |= 0x00000020;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          net.axod.DHTProtos.Message.Peer, net.axod.DHTProtos.Message.Peer.Builder, net.axod.DHTProtos.Message.PeerOrBuilder> providerPeersBuilder_;
       ...
       * <code>repeated .Message.Peer providerPeers = 9;</code>
       */
      public Builder addProviderPeers(net.axod.DHTProtos.Message.Peer value) {
        if (providerPeersBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .Message.Peer providerPeers = 9;</code>
       */
      public net.axod.DHTProtos.Message.Peer.Builder getProviderPeersBuilder(
          int index) {
       ...
       * <code>repeated .Message.Peer providerPeers = 9;</code>
       */
      public net.axod.DHTProtos.Message.Peer.Builder addProviderPeersBuilder() {
    ...
    private static final net.axod.DHTProtos.Message DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new net.axod.DHTProtos.Message();
    }

    public static net.axod.DHTProtos.Message getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
